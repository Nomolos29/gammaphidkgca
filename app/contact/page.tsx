    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-6 md:px-12 bg-secondary">
        <div className="container-narrow text-center">
          <span className="text-small uppercase tracking-widest text-accent">Get In Touch</span>
        ...
        <div className="container-narrow">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <h2 className="heading-md text-foreground mb-8">Chapter Information</h2>

              {/* Location */}
              <div className="card-elegant border border-border">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-rose-light flex items-center justify-center">
              ...
              {/* Join CTA */}
              <div className="card-elegant bg-rose-light">
                <h3 className="heading-sm text-foreground mb-4">Interested in Joining?</h3>
